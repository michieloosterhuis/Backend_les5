...
public class PokemonGymImpl implements PokemonGym {
    ...
    public void fightRound(PokemonTrainer trainer, PokemonGymOwner owner, Pokemon pokemon, Pokemon gymPokemon) {
        ...
        if (gymPokemon.getHp() <= 0){
            ...
            owner.getPokemons().remove(gymPokemon);
        }

        if (owner.getPokemons().size() == 0) {
            System.out.println(owner.getName() + " does not have any Pokemon left to play with.");
            System.out.println("Thank you for playing");
        } else if (trainer.getPokemons().size() == 0) {
            System.out.println(trainer.getName() + " does not have any Pokemon left to play with.");
            System.out.println("Thank you for playing");
        } else {
